...
exports.updateFranchisor = asyncHandler(async (req, res) => {
    ...
    const franchisorData = { name, cnpj, email, phone };
    const updatedFranchisor = await franchisorRepository.update(id, franchisorData);
...
exports.deleteFranchisor = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({ message: 'Franqueadora deletada com sucesso. Os tenants associados foram desvinculados.' });
});
