    ...
    return (
        <Paper sx={{ p: 2 }}>
            ...
            {loading ? (
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Paper elevation={1} sx={{ p: 2 }}>
                            <Typography variant="h6" align="center">NPS do Dia</Typography>
                    ...
                    <Grid item xs={12} md={6}>
                        <Paper elevation={1} sx={{ p: 2 }}>
                            ...
                            {/* Poderia adicionar um gráfico de linha aqui se tivéssemos dados horários */}
                        </Paper>
                    </Grid>
                ...
                <Typography>Nenhum dado disponível para a data selecionada.</Typography>
            )}
        </Paper>
    );
};
