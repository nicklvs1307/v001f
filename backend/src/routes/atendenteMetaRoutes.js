...
router.post(
  ...
  [
    ...
    check("npsGoal", "Meta de NPS deve ser um número entre 0 e 100").optional().isFloat({ min: 0, max: 100 }),
    check("responsesGoal", "Meta de Respostas deve ser um número inteiro maior ou igual a 0").optional().isInt({ min: 0 }),
    check("registrationsGoal", "Meta de Cadastros deve ser um número inteiro maior ou igual a 0").optional().isInt({ min: 0 }),
  ],
  validate,
