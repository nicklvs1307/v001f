const { AtendentePremiacao, Atendente, Recompensa, AtendenteMeta, Tenant } = require('../../models');
  ...
  getAllPremiacoes: async (tenantId) => {
    return AtendentePremiacao.findAll({
      ...
      include: [
        ...
        { model: AtendenteMeta, as: 'meta', attributes: ['id', 'npsGoal', 'responsesGoal', 'registrationsGoal'] },
